...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('aanany@uoguelph.ca');
    setCopied(true);
  }
  return (
    <div
      ...
      style = {{
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(36,36,124,1) 27%, rgba(86,118,125,1) 100%)',
      }}
    >
